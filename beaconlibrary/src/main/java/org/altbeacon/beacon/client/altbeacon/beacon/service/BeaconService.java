 ...
 * under the License.
 */
package org.altbeacon.beacon.client.altbeacon.beacon.service;
...
import org.altbeacon.beacon.client.altbeacon.beacon.BeaconManager;
import org.altbeacon.beacon.client.altbeacon.beacon.BeaconParser;
import org.altbeacon.beacon.client.altbeacon.beacon.Region;
import org.altbeacon.beacon.client.altbeacon.beacon.distance.DistanceCalculator;
import org.altbeacon.beacon.client.altbeacon.beacon.distance.ModelSpecificDistanceCalculator;
import org.altbeacon.beacon.client.altbeacon.beacon.logging.LogManager;
import org.altbeacon.beacon.client.altbeacon.beacon.service.scanner.CycledLeScanCallback;
import org.altbeacon.beacon.client.altbeacon.beacon.service.scanner.CycledLeScanner;
import org.altbeacon.beacon.client.altbeacon.beacon.service.scanner.NonBeaconLeScanCallback;
import org.altbeacon.beacon.client.altbeacon.beacon.startup.StartupBroadcastReceiver;
import org.altbeacon.beacon.client.altbeacon.bluetooth.BluetoothCrashResolver;
            ...
            if (service != null) {
                switch (msg.what) {
                    case MSG_START_RANGING:
                        ...
                        service.startRangingBeaconsInRegion(startRMData.getRegionData(), new org.altbeacon.beacon.client.altbeacon.beacon.service.Callback(startRMData.getCallbackPackageName()));
                    ...
                    case MSG_START_MONITORING:
                        ...
                        service.startMonitoringBeaconsInRegion(startRMData.getRegionData(), new org.altbeacon.beacon.client.altbeacon.beacon.service.Callback(startRMData.getCallbackPackageName()));
                        service.setScanPeriods(startRMData.getScanPeriod(), startRMData.getBetweenScanPeriod(), startRMData.getBackgroundFlag());
                        break;
