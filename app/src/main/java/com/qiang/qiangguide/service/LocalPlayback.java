...
public class LocalPlayback implements  Playback, AudioManager.OnAudioFocusChangeListener,
    ...
    private final BroadcastReceiver mAudioNoisyReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (AudioManager.ACTION_AUDIO_BECOMING_NOISY.equals(intent.getAction())) {
                LogUtil.d(TAG, "Headphones disconnected.");
                if (isPlaying()) {
    ...
    public LocalPlayback(PlayService service, MusicProvider musicProvider) {
    ...
    public void onCompletion(MediaPlayer mp) {
        LogUtil.d(TAG, "onCompletion from MediaPlayer");
    ...
    private void configMediaPlayerState() {
        ...
        if (mAudioFocus == AUDIO_NO_FOCUS_NO_DUCK) {
            ...
            if (mPlayOnFocusGain) {
                if (mMediaPlayer != null && !mMediaPlayer.isPlaying()) {
                    LogUtil.d(TAG,"configMediaPlayerState startMediaPlayer. seeking to ",
                            mCurrentPosition);
    ...
    private void giveUpAudioFocus() {
        LogUtil.d(TAG, "giveUpAudioFocus");
        if (mAudioFocus == AUDIO_FOCUSED) {
